...
call javaapi#interface('ORBInitializer', '', [
  \ ])
...
call javaapi#interface('ObjectReferenceFactory', '', [
...
call javaapi#interface('ObjectReferenceTemplate', '', [
...
call javaapi#interface('PolicyFactory', '', [
  \ ])
...
call javaapi#interface('RequestInfo', '', [
  \ ])
...
call javaapi#interface('ServerRequestInfo', '', [
  \ ])

call javaapi#interface('ServerRequestInfoOperations', '', [
...
call javaapi#interface('ServerRequestInterceptor', '', [
  \ ])

call javaapi#interface('ServerRequestInterceptorOperations', '', [
...
call javaapi#interface('ClientRequestInfo', '', [
  \ ])

call javaapi#interface('ClientRequestInfoOperations', '', [
...
call javaapi#interface('ClientRequestInterceptor', '', [
  \ ])

call javaapi#interface('ClientRequestInterceptorOperations', '', [
...
call javaapi#interface('IORInfo', '', [
  \ ])
...
call javaapi#interface('IORInterceptor', '', [
  \ ])

call javaapi#interface('IORInterceptorOperations', '', [
  \ javaapi#method(0,'establish_components(', 'IORInfo)', 'void'),
  \ ])

call javaapi#interface('IORInterceptor_3_0', '', [
  \ ])
...
call javaapi#interface('IORInterceptor_3_0Operations', '', [
...
call javaapi#interface('Interceptor', '', [
  \ ])
...
call javaapi#class('InvalidSlot', '', [
...
call javaapi#interface('ORBInitInfo', '', [
  \ ])
